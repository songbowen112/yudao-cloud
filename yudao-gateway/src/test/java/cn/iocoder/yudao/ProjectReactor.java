...
public class ProjectReactor {
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.bjhycf.cloud";
        String artifactIdNew = "galaxy";
        String packageNameNew = "com.bjhycf.platform";
        String titleNew = "恒耀智能管理系统";
        String projectBaseDirNew = "/Users/songbowen/repository3/galaxy-cloud"; // 一键改名后，“新”项目所在的目录
